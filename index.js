...
/**
 * commitChanges - commit git changes with a prompt
 *
 * @param {Object} config - config object generated by func(1) async.waterfall
 * @param {String} branch - branch currently on.
 * @param {Function} next - callback(err, config, branch)
 *
...
async.waterfall([
  ...
  process.exit(0); // in case anything is still listening
})
